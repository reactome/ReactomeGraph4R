---
title: "ReactomeGraph4R: an R Interface for Reactome Graph Database"
author: Chi-Lam Poon
...
The [`ReactomeGraph4R`](https://github.com/reactome/ReactomeGraph4R) package is an R interface for retrieving **data with network structure** from [Reactome Graph Database](https://reactome.org/dev/graph-database). There is another R package [`ReactomeContentService4R`](https://github.com/reactome/ReactomeContentService4R) for querying **specific bits of information** to the Reactome Database through the RESTful API in Content Service.
...
Follow this [instruction](https://github.com/reactome/reactome.graphdb4r) to download and setup Reactome Graph Database.

Then install `ReactomeGraph4R` package via CRAN:
```{r install, eval=FALSE}
install.packages("ReactomeGraph4R")
```
